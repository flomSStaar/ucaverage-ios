...
public func loadUEs() -> [UE] {
    ...
    var ue1 = UE(withName: "UE1 Génie Logiciel", andCoef: 6)
    var ue2 = UE(withName: "UE2 Système et Réseaux", andCoef: 6)
    var ue3 = UE(withName: "UE3 Insertion professionnelle", andCoef: 6)
    let ue4 = UE(withName: "UE4 Technologies mobiles 1", andCoef: 9)
...
public func loadBlocks() -> [Block] {
    ...
    block1.ues.append(ue1)
    block1.ues.append(ue2)
    block1.ues.append(ue3)
    
    block2.ues.append(ue2)
    block2.ues.append(ue4)
